<template>
    <div class="card text-center m-3">
        <div class="card-body">
            <notification />
            <v-data-table class="rounded-xl" v-model:sort-by="sortBy" :headers="headers" :items="databases"
                ...
                <template v-slot:top>
                    ...
                    <v-toolbar>
                        <div class="tb-row">
                            ...
                            <v-btn icon="mdi-table-arrow-down" size="large" href="/api/Servers.csv" download></v-btn>
                        </div>
                    </v-toolbar>
                </template>
                ...
                <template v-slot:item.Status="{ item }">
                    <v-chip :color="item.Status == 'Running' ? 'green' : 'red'" :text="item.Status"
